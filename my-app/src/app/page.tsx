    ...
    <>
      <main className="flex px-6 drop-shadow-2xl lg:w-3/4">
        ...
        <section className="bg-azul-escuro hidden lg:block w-1/2 rounded-l-lg">
          <img className="p-6 m-auto" src="/icone-mergulhador.svg" alt="icone de mergulhador" />
        </section>

        <section className="bg-white p-10 gap-6 flex flex-col justify-center rounded-lg lg:w-1/2  lg:rounded-l-none">
